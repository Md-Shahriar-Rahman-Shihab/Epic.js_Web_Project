...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add click event listener to view plan button
    const viewPlanBtn = document.querySelector('.view-plan-btn');
    if (viewPlanBtn) {
        viewPlanBtn.addEventListener('click', () => {
            // Add your view plan logic here
            console.log('View Plan clicked');
        });
    }

    // Add click event listener to query button
    const queryBtn = document.querySelector('.query-button button');
    if (queryBtn) {
        queryBtn.addEventListener('click', () => {
            // Add your query button logic here
